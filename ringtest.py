...
parser.add_argument("-branch", metavar='N', nargs=2, help="range of branches per cell (default 10 20)", type=int, default=[10,20])
parser.add_argument("-compart", metavar='N', nargs=2, help="range of compartments per branch (default [1,1])", type=int, default=[1,1])
...
if __name__ == '__main__':
  ...
  if rank == 0:
    print ("runtime=%g  load_balance=%.1f%%  avg_comp_time=%g" % (runtime, load_balance*100, avg_comp_time))
